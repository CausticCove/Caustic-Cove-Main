/datum/action/innate/vore_mode
	...
	click_action = TRUE
	ranged_mousepointer = 'modular_caustic/icons/effects/mouse_pointers/vore.dmi'
	default_button_position = "EAST-4:6,SOUTH+1:5" // We're bottom left, it's bottom right, it's perfect

	background_icon = 'modular_caustic/icons/mob/actions/vore.dmi'
	background_icon_state = "bg"
	button_icon = 'modular_caustic/icons/mob/actions/vore.dmi'
...
/datum/action/innate/vore_mode/create_button()
	...
	button.mouse_drag_pointer = 'modular_caustic/icons/effects/mouse_pointers/vore_drag.dmi'
	return button
